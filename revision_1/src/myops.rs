...
impl Add for Person {
  ...
  fn add(self, rhs: Self) -> Self::Output {
    Self::Output {husband: self, wife: rhs, location: "Dubai".to_string() }  
  }
}
...
pub fn test_custom_ops() {
  ...
  let husband = format!("{} {}", marraige.husband.firstname, marraige.husband.lastname);
  let wife = format!("{} {}", marraige.wife.firstname, marraige.wife.lastname);
  
  println!("{} got married to {} at {}", husband, wife, marraige.location);
}